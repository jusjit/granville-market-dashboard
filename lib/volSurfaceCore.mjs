...
export async function computeVolSurface(tradierKey, prevPoints = null) {
  ...
  for (let i = 1; i < points.length; i++) {
    ...
    b.forwardNearExp = a.expiration
    b.forwardFarExp = b.expiration
    b.ivGap = b.forwardIV != null ? +(b.forwardIV - b.spotIV).toFixed(6) : null
  }
  points[0].forwardIV = null
  points[0].forwardNearExp = null
  points[0].forwardFarExp = null
  points[0].ivGap = null
